...
# 1) Upload data
  ...
  # 1.2) Upload 2023 industrious elephant ######
      # 1.2.1) Upload excels ########
      ...
      files<- grep("/Quality Controlled/|/Extracted/|/QCed/",files,value=T)
  ...
  # 1.5) Upload environmental data ####
    # 1.5.1) Aspect, slope, elevation ######
    ...
    upload_files_to_s3(files = files[3],
                       selected_bucket=s3_bucket,
                       max_attempts = 3,
                       overwrite=T,
                       mode="public-read")
